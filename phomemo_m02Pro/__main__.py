...
import phomemo_m02Pro.printer
import phomemo_m02Pro._image_helper
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--width", type=int, default=phomemo_m02Pro.printer.Printer.MAX_WIDTH
    )
    parser.add_argument("--test", action="store_true", default=False)
    parser.add_argument("--convert-only", action="store_true", default=False)
    parser.add_argument("--port", default="/dev/tty.M02Pro")
    ...
    if args.convert_only:
        phomemo_m02Pro._image_helper.preprocess_image(
